...
class CrimeData(models.Model):
    ...
    occurred_time = models.TimeField() # need to check
    ...
    premises_code = models.IntegerField(null=True, blank=True)
    premises_name = models.CharField(max_length=255, null=True, blank=True)
    used_weapon_code = models.IntegerField(null=True, blank=True)
    ...
    other_crime_type_code_1 = models.IntegerField(null=True, blank=True)
    other_crime_name_code_1 = models.CharField(max_length=255,null=True, blank=True)
    other_crime_type_code_2 = models.IntegerField(null=True, blank=True)
    other_crime_name_code_2 = models.CharField(max_length=255, null=True, blank=True)
    other_crime_type_code_3 = models.IntegerField(null=True, blank=True)
    other_crime_name_code_3 = models.CharField(max_length=255, null=True, blank=True)
    other_crime_type_code_4 = models.IntegerField(null=True, blank=True)
